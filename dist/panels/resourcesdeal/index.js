...
// 筛选相关
let _originalImageData = []; // 原始图片数据
let _originalPrefabData = []; // 原始预制体数据
let _filteredImageData = []; // 筛选后的图片数据
let _filteredPrefabData = []; // 筛选后的预制体数据
// #endregion
// #region 工具函数
    ...
    methods: {
        ...
        renderPrefabTable(prefabMaps_name, spriteFrameMaps_name) {
            ...
            Object.entries(prefabMaps_name).forEach(([prefab, imgs]) => {
                ...
                const imgSizes = sortedImgs.map(img => { var _a, _b; return formatSize(((_b = (_a = _dataCache === null || _dataCache === void 0 ? void 0 : _dataCache.path2info) === null || _a === void 0 ? void 0 : _a[img]) === null || _b === void 0 ? void 0 : _b.size) || 0); });
                const totalSize = sortedImgs.reduce((sum, img) => { var _a, _b; return sum + (((_b = (_a = _dataCache === null || _dataCache === void 0 ? void 0 : _dataCache.path2info) === null || _a === void 0 ? void 0 : _a[img]) === null || _b === void 0 ? void 0 : _b.size) || 0); }, 0);
                const imgCounts = sortedImgs.map(img => { var _a, _b; return (((_b = (_a = _dataCache === null || _dataCache === void 0 ? void 0 : _dataCache.path2info) === null || _a === void 0 ? void 0 : _a[img]) === null || _b === void 0 ? void 0 : _b.count) || 0); });
                rows.push({
                    prefab,
                    imgs: sortedImgs,
                    count: imgCounts,
        ...
        // #region 筛选功能方法
        applyImageFilter() {
            const filterValue = this.$.imageFilter.value.trim().toLowerCase();
            ...
            // 如果有筛选关键词，进行筛选
            if (filterValue) {
                filteredRows = _originalImageData.filter(row => row.img.toLowerCase().includes(filterValue));
            }
            // 生成筛选后的表格行HTML
            ...
            if (filterValue) {
                ...
                // 如果没有筛选条件，显示原始统计
                const unusedCount = _dataCache ? Object.values(_dataCache.path2info).filter((info) => info.count === 0).length : 0;
        ...
        async deleteEmptyFolders() {
            ...
            try {
                ...
                if (result.success) {
                    Editor.Dialog.info(`删除完成！\n删除了 ${result.deletedCount} 个空文件夹`, { title: '删除空文件夹', buttons: ['我知道了'] });
