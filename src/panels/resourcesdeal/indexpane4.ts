...
export class Panel4Manager {
     ...
     */
    static showSelectionPreview(itemId: string, itemName: string, matchedImages: string[], regex: string, moveItem: MoveItem) {
        ...
        const closeBtn = dialog.querySelector('#closeSelection') as HTMLButtonElement;
